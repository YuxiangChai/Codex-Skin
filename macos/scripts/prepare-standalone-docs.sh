...
WINDOWS_ASSET_URL='https://github.com/YuxiangChai/Codex-Skin/blob/main/windows/assets/'
...
for file in "$DOCS_TARGET"/*.md; do
  ...
  /usr/bin/sed \
    ...
    -e "s#https://github.com/YuxiangChai/Codex-Skin/tree/main/windows/assets/#${WINDOWS_ASSET_TOKEN}#g" \
