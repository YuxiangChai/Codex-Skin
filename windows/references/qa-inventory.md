...
- Tray lifecycle: pause/resume reflects the clicked state, the sole bundled Iron Man theme is present on first install, and complete restore terminates any separately launched tray before it can reapply the skin.
